...
const TicketCheckoutForm = ({ Secret, datas }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (paymentIntent) {
            try {
                const response = await (datas.isUser === 'user' ? userApi : clubApi).post('/ticketpaymentsuccess', { ...datas });
                datas.isUser === 'user'
                    ? navigate(`/user/ticketsuccesspage`, { state: response.data.datas })
                    : navigate(`/club/ticketsuccesspage`, { state: response.data.datas });
            } catch (apiError) {
